    ...
    public function up()
    {
        DB::statement("
            ...
            (
                select * from 
                (
                    select `content`.`language_id` ,'article' AS `type` ,`content`.`name` AS `name` ,`content`.`content_id` AS `model_id`,'App/Models/WebContent' AS `model_type` from `web_content_translations` `content` 
                    ...
                    union all select `contact`.`language_id` ,'contact' AS `type` ,`contact`.`name` AS `name` ,`contact`.`content_id` AS `model_id`,'App/Models/WebContactCategories' AS `model_type` from `web_contact_content_translations` `contact` 
                    union all select `vacancy`.`language_id` ,'vacancy' AS `type` ,`vacancy`.`name` AS `name` ,`vacancy`.`content_id` AS `model_id`,'App/Models/WebVacancies' AS `model_type` from `web_vacancy_content_translations` `vacancy` 
