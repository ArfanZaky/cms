    ...
    public function up()
    {
        DB::statement("
            ...
            (
                ...
                union all select `chatbot`.`chatbot_category_id` AS `id_table`,`chatbot`.`language_id` AS `language`,'chatbot' AS `code`,`chatbot`.`slug` AS `slug` from `web_chatbot_categories_translations` `chatbot`
            )
        ");
    }
