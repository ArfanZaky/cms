...
<div class="col-6" style="align-self: center;">
    <input id="thumbnail-{{$i}}" style="display: none"  class="form-control" type="text" name="image_lang[]">
...
<div class="col-6">
    <div class="image_list_preview position-relative">
        <img src="{{ asset('assets/img/default.jpg') }}" id="holder-{{$i}}" width="400px" height="400px" alt="image"
