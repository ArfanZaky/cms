...
<style>
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('article.store') }}" method="POST" novalidate  class="needs-validation" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <div class="card">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="zone" id="select-picker" class="form-control input-sm show-tick select2" data-live-search="true" required>
                                                    @foreach($zone as $zoneItem)
                                                        <option value="{{ $zoneItem['id'] }}" {{ $zoneItem['id'] == old('zone') ? 'selected' : '' }}>
                                                            {{$zoneItem['name']}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="row p-2" >
                                                    ...
                                                    <div class="col-6">
                                                        <div class="image_list_preview" onclick="OpenModal()">
                                                            {{-- icon pdf --}}
                                                            <img class="img-fluid"
                                                                src="{{ asset('assets/img/pdf.png') }}" alt="Preview">
                                                                <br>
                                                            <small style="color:black">Click For Preview</small>
                                                           
                                                        </div>
                                                        <input id="attachment-0" data-id="0" 
                                            ...
                                            @if(isset(config('cms.visibility.post.item')[$parent_categories->visibility]))
                                                @foreach(config('cms.visibility.post.item')[$parent_categories->visibility] as $key => $value)
                                                    <div class="form-check">
                                                        <input class="form-check-input"  checked type="radio" name="visibility" id="visibility2" value="{{$key}}">
       ...
       <div class="modal fade" id="modal-preview" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                ">
                    <embed id="attachment_preview-0" src="" frameborder="0" width="100%" height="500px"/>
                </div>
            </div>
        </div>
    </div>
