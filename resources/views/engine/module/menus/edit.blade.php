...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('menu.update', $data->id) }}" novalidate class="needs-validation" method="POST">
                        @csrf
                        <div class="col-12">
                            <div class="card">
                                        ...
                                        <div class="tab-pane fade show {{ $i == 0 ? 'active' : '' }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[]"
                                                    ...
                                                    value="{{ $data->translations[$i]->name ?? '' }}">
                                            </div>
                                            @error('name.' . $i)
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="menu_id" id="select-picker"
                                                ...
                                                @foreach ($menu_table_menu as $menus)
                                                    <option value="{{ $menus['id'] }}"
                                                        {{ $menus['id'] == $data->menu_id ? 'selected' : '' }}>
                                                        <?php
                                                        $menus['name'] = str_replace('<i class="fa fa-angle-double-right"></i>', '-', $menus['name']);
                                                        $menus['name'] = str_replace('<i class="fa fa-bars"></i>', '-', $menus['name']);
                                                        ?>
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent2">
                                        ...
                                        <div class="tab-pane fade show {{ $i == 0 ? 'active' : '' }}  seo_{{ $i }}"
                                            ...
                                            aria-labelledby="{{ $array_languages[$i] }}">
                                            <div class="card-body row">
                                                @include('engine.include.image.language.default.update')
                                                @include('engine.include.image.language.mobile.update')
                                            </div>
                                            ...
                                            @foreach (config('cms.visibility.menu') as $key => $value)
                                                <div class="form-check">
                                                    <input class="form-check-input"
                                                        {{ $data->visibility == $key ? 'checked' : '' }} type="radio"
                                                        name="visibility" value="{{ $key }}">
