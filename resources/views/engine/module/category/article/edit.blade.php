        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    $url = route('category.article.update', [$data->id,'parent' => request()->get('parent'), 'component' => request()->get('component')]);
                    ?>
                    <form action="{{ $url }}" novalidate  class="needs-validation" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12" style="display: none;">
                            <div class="card">
                                <div class="card-header">
                                    <h4>For Calculate Loan</h4>
                                </div>
                                <div class="card-body">
                                    @include('engine.include.loan.edit')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12" style="display: none;">
                            <div class="card">
                                <div class="card-header">
                                    <h4>For Calculate Deposit</h4>
                                </div>
                                <div class="card-body">
                                    @include('engine.include.deposit.edit')
                                </div>
                            </div>
                        </div>
