...
<style>
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('vacancy.update', $data->id) }}" method="POST" novalidate  class="needs-validation" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="myTabContent2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city" name="city" required class="form-control"  value="{{ $data->city }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="salary">Salary  </label>
                                            <input type="text" id="salary" name="salary" required class="form-control"  value="{{ $data->salary }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="experience">Experience  </label>
                                            <textarea name="experience" id="experience" required class="form-control" cols="30" rows="10">{{ $data->experience }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="position">Position  </label>
                                            <input type="text" id="position" name="position" required class="form-control"  value="{{ $data->position }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
